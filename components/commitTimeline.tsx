    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                ...
                <div className="bg-gray900 rounded-xl border border-gray800 p-5 shadow-lg sticky top-[calc(50vh+3rem)]">
            ...
            <div className="lg:col-span-3 space-y-8">
                {timelineGroups.map((group, groupIndex) => {
                    ...
                    return (
                        <div key={group.repo} className="bg-gray900 rounded-2xl border border-gray800 shadow-xl overflow-hidden animate-fade-in" style={{ animationDelay: `${groupIndex * 100}ms` }}>
                            {/* Header Collapsible */}
                            <div
                                onClick={() => toggleRepo(group.repo)}
                                className="bg-gray950/50 px-6 py-4 border-b border-gray800 flex items-center gap-3 cursor-pointer hover:bg-gray900 transition-colors select-none"
                            >
                                <div className="p-2 bg-gray800 rounded-lg text-white transition-transform duration-300">
                            ...
                            {!isCollapsed && (
                                <div className="divide-y divide-gray800 bg-gray900">
                                            ...
                                            <div className="flex items-start gap-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-gray-500 mt-2">
                                                        ...
                                                        <span className="flex items-center gap-1 font-mono bg-gray950 px-1.5 py-0.5 rounded border border-gray800 opacity-60">
